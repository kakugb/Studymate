...
<aside
 ...
 aria-label="Sidebar"
>
<div className="h-full w- px-3 py-2 overflow-y-auto bg-gray-50 dark:bg-gray-800  " id="navbar-default">
  <ul className="space-y-2 font-medium">
    <h2 className="w-full mb-4 text-3xl text-center font-bold">Studymate</h2>
    {role === "admin" && (
      <>
        <li>
          <Link
