        ...
        const fetchUserData = async () => {
          try {
            ...
            const response = await axios.get(
              `${process.env.REACT_APP_SECRET_KEY}/calender/get-event/${userId}`,
              config
            );
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          ...
          await axios.put(`${process.env.REACT_APP_SECRET_KEY}/calender/update-event/${userId}`, userData, config);
