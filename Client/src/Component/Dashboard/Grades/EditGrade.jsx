...
function EditGrade() {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
          try {
            ...
            const response = await axios.get(
              `${process.env.REACT_APP_SECRET_KEY}/grade/get-grade/${userId}`,
              config
            );
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          ...
          await axios.put(`${process.env.REACT_APP_SECRET_KEY}/grade/update-grade/${userId}`, userData, config);
  
          toast.success("Grades Edit successfully!");
  ...
  return (
    ...
    <div className="flex flex-col flex-1 overflow-hidden">
      ...
      {/* Main content */}
      <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 " style={{ backgroundImage: `url(${grade})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
